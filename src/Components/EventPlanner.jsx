    ...
    <div className="event-planner-container">
        ...
        <section className="description">
            <p>
                ...
                cumpleaños hasta reuniones corporativas, tenemos todo cubierto.
            </p>
        ...
        <section className="testimonials">
            ...
            <div className="testimonial">
                <p>"Uso Event Planner para todos mis eventos corporativos. ¡Me ahorra mucho tiempo y esfuerzo!"</p>
